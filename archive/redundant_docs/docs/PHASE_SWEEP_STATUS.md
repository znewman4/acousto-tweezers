⚠️ **Historical Document** — This report documents exploratory phase-sweep studies from early February 2026. The workflows and physics described here have been **superseded by the current 3D ParaView workflow** documented in [README.md](../README.md) § "Current Working Workflow". Results from this study have been archived in `results/ARCHIVE_PRE_3D_PARAVIEW_WORKFLOW/`.
